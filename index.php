<?php
include 'framework-br/src/BR_Framework.php';
...
####################################################################################################################
//$nome_cookie = 'meu_cookie';
//$valor_cookie = 'valor_do_cookie';
//$tempo_expiracao = time() + (3600 * 24 * 30); // 30 dias a partir de agora
//br()->secure_cookie("$nome_cookie", "$valor_cookie", "$tempo_expiracao");
####################################################################################################################
